...
<main>
    <div id="brigadeiro1">
        <img id="imgBrigadeiro" src="./images/cupcakeBaunilha.webp">
        <h1 class="titleBaunilha">Cupcake de baunilha</h1>
    </div>
    <div id="brigadeiro2">
        <img id="imgBrigadeiro" src="./images/cupcakeFerreroRouche.jpg">
        <h1 class="title2">Cupacke de ferrero roche</h1>
    </div>
    <div id="brigadeiro3">
        <img id="imgBrigadeiro" src="./images/cupcakeMenta.jpg">
        <h1 class="title3">Cupcake sabor menta</h1>
    </div>
</main>
`;
